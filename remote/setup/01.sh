...
# the dsn in the script).
read -p "Enter dsn for the database: " DSN
...
# Add a DSN for connecting to the gotrello database to the system-wide environment 
# variables in the /etc/environment file.
echo "DB_DSN='${DSN}'" >> /etc/environment
